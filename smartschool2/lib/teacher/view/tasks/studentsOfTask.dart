...
import 'package:smartschool2/student/Widgets/custom_appbar.dart';
import 'package:smartschool2/student/view/Home/home_appbar.dart';
import 'package:smartschool2/teacher/controllers/TasksControllers/CheckedStudentTaskInfoController.dart';
import 'package:smartschool2/teacher/controllers/TasksControllers/studentTaskInfo.dart';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () async {
        ...
        await openFile(
          url: taskUrl,
          fileName: name + ' soultion for ' + data['taskName'],
        );
      },
      child: Column(
        children: [
