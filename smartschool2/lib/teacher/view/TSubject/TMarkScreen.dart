...
import 'package:smartschool2/student/Widgets/animated_progress_indicator.dart';
import 'package:smartschool2/student/Widgets/custom_progress_indecator.dart';
import 'package:smartschool2/teacher/controllers/SubjectController/TMarksController.dart';
import 'package:smartschool2/teacher/view/SProfile/SProfileScreen.dart';
...
class TMarkScreen extends StatelessWidget {
  const TMarkScreen({Key? key, this.subjectId, this.grade, this.classId})
    : super(key: key);
  final subjectId;
  final grade;
  final classId;
...
class StudentsMarksCard extends StatelessWidget {
  const StudentsMarksCard({Key? key, this.mark, this.name, this.url, this.id})
    : super(key: key);
