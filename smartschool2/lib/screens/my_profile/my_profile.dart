import 'package:smartschool/constants.dart';
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            sizedBox,
            ProfileDetailColumn(title: 'Email', value: 'aisha12@gmail.com'),
            ProfileDetailColumn(title: 'Father Name', value: 'John Mirza'),
            ProfileDetailColumn(title: 'Mother Name', value: 'Angelica Mirza'),
            ProfileDetailColumn(title: 'Phone Number', value: '+923066666666'),
          ],
        ),
      ),
    );
        ...
        children: [
          Column(
            ...
            children: [
              ...
              kHalfSizedBox,
              SizedBox(width: 35.w, child: Divider(thickness: 1.0)),
            ],
          ),
        ...
        children: [
          Column(
            ...
            children: [
              ...
              Text(value, style: Theme.of(context).textTheme.labelSmall),
              kHalfSizedBox,
              SizedBox(width: 92.w, child: Divider(thickness: 1.0)),
            ],
          ),
          Icon(Icons.lock_outline, size: 10.sp),
        ],
