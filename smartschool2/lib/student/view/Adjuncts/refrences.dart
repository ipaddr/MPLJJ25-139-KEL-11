...
import 'package:smartschool2/student/controllers/RefrencesController.dart';
                      ...
                      if (_controller.filesinfo.isEmpty) {
                        ...
                        if (!_controller.isFiltred) {
                          return RefrenecesFileCard(
                            ...
                            subject: _controller.filesinfo.value[index].subject,
...
class RefrenecesFileCard extends StatelessWidget {
  const RefrenecesFileCard({Key? key, this.filename, this.subject, this.url})
    : super(key: key);
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Padding(
              padding: EdgeInsets.only(right: 16.w, top: 10.h, bottom: 0.h),
              child: Column(
                children: [
                  IconButton(
                    onPressed: () async {
