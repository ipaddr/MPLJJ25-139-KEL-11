...
import 'package:smartschool2/student/models/programs/programModel.dart';
import 'package:smartschool2/student/view/Home/subjectCart.dart';
                  ...
                  InkWell(
                    onTap: () async {
                      ...
                      /*try{ final taskId = await FlutterDownloader.enqueue(
                        ...
                        savedDir:
                            '/data/user/0/com.example.smartschool2/files/',
                        showNotification:
